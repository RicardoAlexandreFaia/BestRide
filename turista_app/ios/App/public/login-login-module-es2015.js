...
let LoginApiService = class LoginApiService {
    constructor(http, router, alertController, nativeStorage) {
        this.http = http;
        this.router = router;
    ...
    login_user(email, password, login_automatic) {
        let data = {
            email: email,
            password: password,
        };
        this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + this.url_login, data).subscribe((data) => {
    ...
    showAlert(header, message, button_text) {
...
/* harmony import */ var _login_api_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./login-api.service */ "24lj");
/* harmony import */ var _create_account_create_account_api_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../create_account/create-account-api.service */ "/udu");
...
let LoginPage = class LoginPage {
    constructor(formBuilder, router, http, translateService, alertCtrl, loginApi, storage, comp, account_api) {
