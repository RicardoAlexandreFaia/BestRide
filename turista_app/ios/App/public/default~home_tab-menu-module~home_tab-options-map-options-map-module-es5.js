(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~home_tab-menu-module~home_tab-options-map-options-map-module"], {
    ...
    /***/
    function SW(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OptionsMapPage", function () {
        return OptionsMapPage;
      });
      /* harmony import */
      ...
      var _raw_loader_options_map_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./options-map.page.html */
      "qRcW");
      /* harmony import */


      var _options_map_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./options-map.page.scss */
      "zpPk");
      /* harmony import */
      ...
      var _roadMap__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../roadMap */
      "1IJX");

      var OptionsMapPage = /*#__PURE__*/function () {
        function OptionsMapPage(modalController, formBuilder, map_service) {
          _classCallCheck(this, OptionsMapPage);
        ...
        _createClass(OptionsMapPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "submit_form",
          value: function submit_form() {
            var _this = this;

            this.map_service.get_roads().subscribe(function (data) {
              for (var pos in data) {
                _this.trips.push(new _roadMap__WEBPACK_IMPORTED_MODULE_7__["RoadMap"](data[pos].id, data[pos].title, data[pos].duration, data[pos].price, data[pos].description, data[pos].image, data[pos].location['coordinates'][0], data[pos].location['coordinates'][1]));
              } //this.trips = data;
      ...
      OptionsMapPage.ctorParameters = function () {
        return [{
      ...
      OptionsMapPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function qRcW(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(MapServiceService, [{
          ...
          value: function getUserPosition() {
            ...
            this.geolocation.getCurrentPosition().then(function (res) {
              console.log('ANSE');
              console.log(res);
              _this2.user = new _user__WEBPACK_IMPORTED_MODULE_5__["User"](res.coords.latitude, res.coords.longitude);
    ...
    /***/
    function zpPk(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=default~home_tab-menu-module~home_tab-options-map-options-map-module-es5.js.map